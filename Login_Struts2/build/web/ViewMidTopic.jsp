                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse">
                            <ul class="nav navbar-nav navbar-left">
                                ...
                                <p:form action="searchMidTopic" method="post">
                                    <p:textfield name="topicid" />
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="header">
                                        <h4 class="title">View Trainer in topic</h4>
                                    </div>
                                    <div class="content">
                                        <div id="page-inner"> 
                                            <form>
                                                <table Border="1" width="60%" align="centter">
                                                    ...
                                                    <p:iterator var="p" value="midTopic">
                                                        <tr>
                                                            <td><p:property value="#p.topicid"/>${p.topicid}</td>
